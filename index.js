...
class CubeView extends Component {
    ...
    createFaceCube(size, x, y, z) {
        ...
        var material = new THREE.MeshBasicMaterial({ color: this.hoverColor, transparent: false, opacity: 0.5, visible: false }); //change to false later
    ...
    createEdgeCube(size, x, y, z) {
        ...
        var c_cube = size / 4; //corner cubes
        //*creating small cubs
        var material = new THREE.MeshBasicMaterial({ color: this.hoverColor, transparent: false, opacity: 1, visible: false, blending: THREE.MultiplyBlending, side: THREE.DoubleSide }); //change to false later
        var geometry = new THREE.BoxGeometry(sizex, sizey, sizez);
    ...
    createCornerCube(size, x, y, z) {
        ...
        var c_cube = size / 4; //corner cubes
        //*creating small cubs
        var material = new THREE.MeshBasicMaterial({ color: this.hoverColor, transparent: false, opacity: 0.5, visible: false });
