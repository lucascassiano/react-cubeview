...
var _cubeview_TOP = require('./img/cubeview_TOP.png');

var _cubeview_TOP2 = _interopRequireDefault(_cubeview_TOP);

var _cubeview_RIGHT = require('./img/cubeview_RIGHT.png');

var _cubeview_RIGHT2 = _interopRequireDefault(_cubeview_RIGHT);

var _cubeview_LEFT = require('./img/cubeview_LEFT.png');

var _cubeview_LEFT2 = _interopRequireDefault(_cubeview_LEFT);

var _cubeview_FRONT = require('./img/cubeview_FRONT.png');

var _cubeview_FRONT2 = _interopRequireDefault(_cubeview_FRONT);

var _cubeview_BACK = require('./img/cubeview_BACK.png');

var _cubeview_BACK2 = _interopRequireDefault(_cubeview_BACK);

var _cubeview_BOTTOM = require('./img/cubeview_BOTTOM.png');

var _cubeview_BOTTOM2 = _interopRequireDefault(_cubeview_BOTTOM);

var _cubeview_SHADOW = require('./img/cubeview_SHADOW.png');

var _cubeview_SHADOW2 = _interopRequireDefault(_cubeview_SHADOW);

var _cubeview_HOME = require('./img/cubeview_HOME.svg');

var _cubeview_HOME2 = _interopRequireDefault(_cubeview_HOME);

var _cubeview_HOME_hover = require('./img/cubeview_HOME_hover.svg');

var _cubeview_HOME_hover2 = _interopRequireDefault(_cubeview_HOME_hover);
...
var CubeView = function (_Component) {
    ...
    function CubeView(props) {
        ...
        _this.DEBUG = _this.props.DEBUG ? _this.props.DEBUG : false;
        _this.state = {
            icon_home: _cubeview_HOME2.default
        };

        _this.hoverHomeOn = _this.hoverHomeOn.bind(_this);
        _this.hoverHomeOff = _this.hoverHomeOff.bind(_this);
        _this.clickHome = _this.clickHome.bind(_this);
        return _this;
    }

    CubeView.prototype.componentDidMount = function componentDidMount() {
    ...
    CubeView.prototype.onMouseDown = function onMouseDown(event) {
        this.mouseMoving = false;
    };

    CubeView.prototype.onMouseUp = function onMouseUp(event) {
    ...
    CubeView.prototype.setViewAngle = function setViewAngle(name) {
        var phi, theta;
    ...
    CubeView.prototype.componentWillUnmount = function componentWillUnmount() {
        var canvas = this.refs.threeCanvas;
        renderer = null;
        scene = null;
        this.camera = null;
    ...
    CubeView.prototype.updateDimensions = function updateDimensions() {
    ...
    CubeView.prototype.init = function init() {
    ...
    CubeView.prototype.onClick = function onClick(event) {
    ...
    CubeView.prototype.onMouseMove = function onMouseMove(event) {
    ...
    CubeView.prototype._render = function _render() {
    ...
    CubeView.prototype._createCube = function _createCube() {
        ...
        var top = this.createTexturedPlane(size, _cubeview_TOP2.default);
        top.position.y = size / 2;
        top.rotation.x = -Math.PI / 2;
        scene.add(top);

        var front = this.createTexturedPlane(size, _cubeview_FRONT2.default);
        front.position.z = size / 2;
        scene.add(front);

        var right = this.createTexturedPlane(size, _cubeview_RIGHT2.default);
        right.position.x = size / 2;
        right.rotation.y = Math.PI / 2;
        scene.add(right);

        var left = this.createTexturedPlane(size, _cubeview_LEFT2.default);
        left.position.x = -size / 2;
        left.rotation.y = -Math.PI / 2;
        scene.add(left);

        var back = this.createTexturedPlane(size, _cubeview_BACK2.default);
        back.position.z = -size / 2;
        back.rotation.y = Math.PI;
        scene.add(back);

        var bottom = this.createTexturedPlane(size, _cubeview_BOTTOM2.default);
        bottom.position.y = -size / 2;
        bottom.rotation.x = Math.PI / 2;
        scene.add(bottom);

        var shadow = this.createTexturedPlane(size + 1.5, _cubeview_SHADOW2.default, false);
    ...
    CubeView.prototype.createFaceCube = function createFaceCube(size, x, y, z) {
    ...
    CubeView.prototype.createEdgeCube = function createEdgeCube(size, x, y, z) {
    ...
    CubeView.prototype.createCornerCube = function createCornerCube(size, x, y, z) {
        var _x = x * 1.01;
        var _y = y * 1.01;
        var _z = z * 1.01;
        var c_cube = size / 4; //corner cubes
    ...
    CubeView.prototype.createTexturedPlane = function createTexturedPlane(size, texturePath) {
    ...
    CubeView.prototype.hoverHomeOn = function hoverHomeOn() {
        this.setState({ icon_home: _cubeview_HOME_hover2.default });
        //this.icon_home = icon_home_hover;
    };

    CubeView.prototype.hoverHomeOff = function hoverHomeOff() {
        this.setState({ icon_home: _cubeview_HOME2.default });
    };

    CubeView.prototype.clickHome = function clickHome() {
        this.controls.setPolarAngle(Math.PI * 0.25);
        this.controls.setAzimuthalAngle(Math.PI * 0.25);
        //this.controls.reset();
        if (this.props.onUpdateAngles) {
    ...
    CubeView.prototype.render = function render() {
